...
class Plant extends Backbone.Model {
  ...
  initialize() {
    _$1.extend(this, this.attributes);
    return this.addEnvironmentalParameters();
  }

  addEnvironmentalParameters() {
    let foundParams = _$1.find(rawTaxonomy, function(plantAttributes) {
      return plantAttributes.taxon === plantAttributes.taxon;
    });

    if (foundParams) {
      return _$1.extend(this, foundParams);
    }
  }
...
class PlantListView extends Backbone.View {
  constructor() {
    ...
    return {
      ...
      template: _$1.template(document.querySelector('#plant-collection-template').innerHTML),
    }
  }
...
undefined.plantList = new PlantCollection();
undefined.plantList.on('add', function(plant) {
