...
var rawPlantData = [
  {
    ...
    "source": {
      ...
      "comments": "Shipped. Arrived potted."
    },
    "notes": [
      {
        "date": "2015-10-05T12:00:00",
        "comments": "shipped from California Carnivores, potted."
      },
      {
        "date": "2016-03-20",
        "comments": "doing quite well"
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      ...
      {
        "date": "2017-06-04",
        "comments": "has a flower stalk growing. noticed a bunch of aphids on the stalk. have to do something about that. healthy looking otherwise."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-15",
        "source": "Bought an unknown Nepenthes from Katsura Bonsai in Japantown.",
        "notes": "Medium sized. Atm the largest in the collection. Many pitchers. All have started wilting, but will bring back to health."
      },
      {
        "date": "2016-10-19",
        "notes": "Based on the bottom half of all the pitchers (the peristome and lid are withered on all) and general shape, I'm going to guess that this is a N. Alata or the hybrid N. Ventrata (alata x ventricosa)."
      },
      {
        "date": "2016-10-23",
        "notes": "Started repotting, and found out this recently bought plant was two! this company based on the label, looks like it is the same I got my next-most recently bought plant from 6th Avenue Aquarium. Now that I'm looking at the plant below the soil (milled peat), it looks like they directly sell cuttings in peat-pucks and drop them in more peat on selling. There was no root structure yet. I went ahead with repotting since I was this far along and gave a mostly sphagnum mix with perlite. I dipped the resuscitated sphagnum in perlite with each handful and then gently packed the plants in larger pots. Hope they survive! I wound up choosing this loose mix based on the Savage Garden's Nepenthes soil section. The other plant at this same arrival date is the other plant in the original pot. Bumped plant ID of other recent plant from NEPEN_16_2 to NEPEN_16_3."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-15",
        "source": "See notes on plant of same day. Bought both at Katsura Bonsai in Japantown."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-20",
        "source": "Bought an unknown Nepenthes from 6th Avenue Aquarium. This is now the largest in my collection. Guessing a N. Alata."
      },
      {
        "date": "2016-10-23",
        "notes": "I hope it isn't the case, but the Nepenthes I repotted today that appeared to be from the same company based on the plant tag were mostly just a peat puck in peat, with no root structure.. It is likely this is the same."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-30",
        "notes": "Seeds arrived a few days ago from ICPS seed bank. Labeled 'Warm Temperate'. Sprinkled seeds on top of a 50:50 peat:sand mix."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-30",
        "notes": "Seeds arrived a few days ago from ICPS seed bank. Labeled 'red/heavy veined, Cold Stratify 4 weeks, Do not plant on Federal property'. I should probably come up with another naming system for seeds. Sprinkled seeds on top of well chopped sphagnum. The sphagnum is a new species from a very generous Redditor. some sections of the sphagnum are red and purple. some is typical bright green too. Placed in a bag in the fridge for cold stratification."
      }
    ],
    "alive": null
  }, {
    "id": "SAPUP6_16_0",
    "taxon": "Sarracenia purpurea var purpurea",
    "notes": [
      {
        "date": "2016-10-30",
        "comments": "Seeds arrived a few days ago from ICPS seed bank. Labeled 'Wisconson, Cold Stratify 4 Weeks'."
      }
    ],
    "alive": null
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-30",
        "notes": "Seeds arrived a few days ago from ICPS seed bank. Labeled 'Pilliga Red, Summer Annual'. Sprinkled seeds on top of a 30% peat to 70% sand mix."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-30",
        "notes": "Seeds arrived a few days ago from ICPS seed bank. Labeled 'Pink Flower, (was indica)'. Sprinkled seeds on top of a 95% sand to 5% peat mix."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-10-30",
        "notes": "arrived a couple days ago, but gave a proper setup today. A generous Redditor sent it to us. Some sections are rather red or purple. a lot is the typical bright green. gave a base of pure peat in a tray. not really sure how much it matters, but tried to detect the parts that were \"the bottom\" and sowed further down in the peat. maybe a bit more than a half inch layer of peat."
      }
    ],
    "alive": true
  }, {
    ...
    "notes": [
      {
        "date": "2016-07",
        "source": "Amazon vendor in July."
      },
      {
        "date": "2016-10-15",
        "notes": "sowed ~100 seeds in 5 small plastic pots. worried about short utric shelf life we read about. soil media was 2:1 peat to sand mix. sand was grade #12. put each container in a sandwich bag, but didn't zip all the way closed. put a bit of distilled water in each bag. placed directly under a light."
      },
      {
        "date": "2017-01-08",
        "notes": "I'm giving up on these guys. I don't believe they're going to sprout. All the seeds have turned green, possibly algae."
      }
    ],
    "alive": false
  }
...
// raw data
// classes
window.ko = knockoutLatest_debug;
knockoutLatest_debug.options.useOnlyNativeEvents = true;
...
class TerrariumApp {
  constructor() {
    ...
    this.taxonomyTree = new TaxonomicTree(rawTaxonomy);
    ...
    this.temporaryPlant = knockoutLatest_debug.observable({
      id: null,
      taxon: null,
    });
...
knockoutLatest_debug.applyBindings(new TerrariumApp());
